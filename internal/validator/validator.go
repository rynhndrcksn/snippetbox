...
// Validator holds any (Non)FieldErrors
type Validator struct {
	FieldErrors    map[string]string
	NonFieldErrors []string // Not related to a specific form field.
}
...
// AddNonFieldError adds errors messages to the NonFieldErrors slice.
